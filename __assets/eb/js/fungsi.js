...
function genGrid(modnya, divnya, lebarnya, tingginya){
	...
	switch(modnya){
		...
		case "produk":
			...
			row_number=true;
			frozen[modnya] = [	
				{field:'tingkatan',title:'Tingkatan',width:100, halign:'center',align:'left'},
				{field:'nama_kategori',title:'Kategori',width:100, halign:'center',align:'left'},
				{field:'judul_produk',title:'Judul Produk',width:350, halign:'center',align:'left'}
			];
			kolom[modnya] = [	
				{field:'berat',title:'Berat',width:150, halign:'center',align:'left'},
				{field:'dimensi',title:'Dimensi',width:150, halign:'center',align:'left'},
